...
/** Visible loading status for Campaign Views. */
export default function CampaignLoadingBanner({
  active,
  label = 'Loading data…',
  detail = null,
}) {
...
export function CampaignLoadingBlock({ label = 'Loading…', minHeight = 120 }) {
  return (
