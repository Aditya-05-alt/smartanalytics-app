-- Standalone Unknown/Other cleanup + status email.
-- Window: 3:00 PM – 4:30 PM IST = 09:30 – 11:00 UTC.
-- days_back = 7. Email after final wave to aditya@brandmirchi.com.
...
$cmd$, base_url || '/logic2-unknown-cleanup-status', svc_key);
  ...
  -- 4:30 PM IST → 11:00 UTC final sweep
  PERFORM cron.schedule('logic2-unknown-cleanup-final', '0 11 * * *', cleanup_cmd);
  -- 4:35 PM IST → 11:05 UTC status email
