-- Fix VDP KPI RPCs: default path uses smart_ga4_page_data (Step 2 tags).
-- smart_final_data is only for inventory-filtered queries (make/model/type).
-- Fix page_path join for Destination Cycle page_path_q_s.
