-- Cascading VDP filter dropdown options (exclude-self per dimension).

-- vdp_filter_inventory_pool.sql + get_vdp_filter_options.sql (see supabase/rpc/)
...
-- Full body in supabase/rpc/get_vdp_filter_options.sql (applied via apply_migration batch)
